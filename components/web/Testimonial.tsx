...
//                   className={`h-3 rounded-full transition-all duration-300 ${index + 1 === current
//                       ? "bg-[#F092B0] w-6"
//                       : "bg-gray-300 w-2"
//                     }`}
            ...
            <div className="flex gap-2">
              {Array.from({ length: count }, (_, index) => (
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className={`h-3 w-${index + 1 === current ? "6" : "2"} rounded-full p-0 transition-all duration-300 ${
                    index + 1 === current ? "bg-pink-500" : "bg-muted"
                  }`}
                  aria-label={`Go to slide ${index + 1}`}
                />
              ))}
