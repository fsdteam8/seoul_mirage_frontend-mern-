...
// ✅ Updated version with mobile-friendly layout, proper alignment, and your original logic kept intact
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-6 lg:py-12 lg:h-16 h-32 w-full">
          ...
          <div className="hidden lg:flex justify-end flex-1 ">
            <NavigationMenu >
              <NavigationMenuList className="space-x-6 p-6">
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="nav-text">
                    {dict.home.navbar.skincare}
                  </NavigationMenuTrigger>
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[280px] sm:w-[350px] p-0">
                ...
                <nav className="flex flex-col p-6 space-y-1">
                  ...
                  <Link href="/about" className="py-3 px-3 text-lg font-medium hover:bg-gray-50 rounded-md" onClick={() => setIsMobileMenuOpen(false)}>
                    {dict.home.navbar.about}
                  </Link>
                  <Link href="/contact" className="py-3 px-3 text-lg font-medium hover:bg-gray-50 rounded-md" onClick={() => setIsMobileMenuOpen(false)}>
                    {dict.home.navbar.contact}
                  </Link>

                  {/* Login + Cart shown under menu */}
                  <div className="mt-6 space-y-3 border-t pt-4">
                    {token || session.status === "authenticated" ? (
                      ...
                      <Link href="/login" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-sm bg-[#F092B0] text-white font-medium text-center">
                        {dict.home.navbar.login}
                      </Link>
                    )}
